   ...
   <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
         ...
         <div class="navbar nav_title" style="border: 0;">
            <a href="index.php" class="site_title"> <span>SPPGB SISWA</span></a>
         </div>
               ...
               <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                        <li><a href="kelolaBiodata.php">Kelola Data Diri</a></li>
                  ...
                  <!-- <li><a><i class="fa fa-edit"></i> Penilaian <span class="fa fa-chevron-down"></span></a>
                     <ul class="nav child_menu">
                        <li><a href="penilaianSiswa.php"> Kelola Penilaian Siswa </a></li>
                     </ul>
                  </li> -->
               </ul>
            </div>
