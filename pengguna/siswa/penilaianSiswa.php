                  ...
                  <div class="dashboard_graph">
                     ...
                     <div class="col-md-9 col-sm-9 text-dark">
                        <form method="POST">
                           ...
                           <div>
                              <label for="nama_pendek" class="h5">Nama:</label>
                              <input type="text" name="nama_pendek" id="nama_pendek" class="h5" required>
                           </div><br>
                           <ol class="h5">
                              <li>
                              ...
                              <li>
                                 <p>Sejauh mana Anda merasa puas dengan kinerja halaman siswa pada website ini?</p>
                                 <ul class="list-unstyled">
