                  ...
                  <div class="dashboard_graph">
                     ...
                     <div class="col-sm-12">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                           ...
                           <tbody>
                              <?php
                           // Retrieve data from the "hasil_pilihan" table for the logged-in user only
                           $loggedInUser = $_SESSION['idUsers']; // ID pengguna yang sedang login
                           $query = "SELECT * FROM hasil_pilihan WHERE idUsers = $loggedInUser";
