   ...
   <div class="container">
      ...
      <div class="content">
         ...
         <section id="hasil" class="section">
            ...
            // Query untuk mengambil data dari tabel "hasil" dengan join ke tabel "users"
            $query = "SELECT hasil.id, users.nama, hasil.hasil, hasil.akurasi, hasil.tanggal FROM hasil JOIN users ON hasil.user_id = users.id WHERE users.users_level = 'user'";
